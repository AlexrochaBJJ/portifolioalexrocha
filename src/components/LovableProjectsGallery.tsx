...
import { lovableProjects } from "@/data/lovableProjects";

const LovableProjectsGallery = () => {
  if (lovableProjects.length === 0) return null;

  return (
    <section id="lovable-projects" className="py-20 px-6 border-t border-border/30">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-card mb-5">
            ...
            <span className="text-xs font-medium text-muted-foreground font-body">
              Projetos web criados com Lovable
            </span>
          </div>
          ...
          <p className="text-muted-foreground max-w-lg mx-auto font-body">
            Aplicações completas que desenvolvi, com autenticação, banco de
            dados e funcionalidades reais. Clique para acessar.
          </p>
